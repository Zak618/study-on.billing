...
class getJmsSerializerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c->registerHandler(1, 'Symfony\\Component\\Form\\Form', 'xml', ['jms_serializer.form_error_handler', 'serializeFormToxml']);
        $c->registerHandler(1, 'Symfony\\Component\\Form\\Form', 'json', ['jms_serializer.form_error_handler', 'serializeFormTojson']);
        $c->registerHandler(1, 'Symfony\\Component\\Form\\FormInterface', 'xml', ['jms_serializer.form_error_handler', 'serializeFormToXml']);
        $c->registerHandler(1, 'Symfony\\Component\\Form\\FormInterface', 'json', ['jms_serializer.form_error_handler', 'serializeFormToJson']);
        $c->registerHandler(1, 'Symfony\\Component\\Form\\FormError', 'xml', ['jms_serializer.form_error_handler', 'serializeFormErrorToxml']);
        $c->registerHandler(1, 'Symfony\\Component\\Form\\FormError', 'json', ['jms_serializer.form_error_handler', 'serializeFormErrorTojson']);
